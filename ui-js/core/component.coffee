Element = require('../dom/nodes/element')
...
module.exports = class Component
	...
	@compile: ->
		if @tag then @tag = @tag.toLowerCase()
	...
	@init: (host, app = null, parentTree = null, parentComponent = null, parentScope = null, beforeConstruct = null)->
	...
	@reload: ->
		...
		for component in @initedComponents.slice()
			...
			newHost = host.clone()
			host.before(newHost) # TODO: cant reload root component, create virtual body
			host.remove(yes)
